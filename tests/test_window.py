...
from hiddenmarkov import HMM, ConstantTransitionModel, WindowedObservationModel

from hiddenmarkov.utils import create_prob_models


class TestWindow(unittest.TestCase):
    def test_window(self):
        prob_models = create_prob_models(no_global_states=100, window_size=2)
        observation_model = WindowedObservationModel(
            prob_models, use_inverted_probs=False, use_log_probabilities=True
        )
